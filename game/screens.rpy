...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("歷史故事") action ShowMenu('history')
...
screen navigation():
        vbox:
            ...
            if main_menu:
                ...
                textbutton _("儲存") action ShowMenu("儲存")

            if main_menu:

                textbutton _("載入") action ShowMenu("載入")
            ...
            textbutton _("環境設定") action ShowMenu("環境設定")
            ...
            textbutton _("關於") action ShowMenu("關於")


            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

                ## Help isn't necessary or relevant to mobile devices.
                textbutton _("幫忙") action ShowMenu("幫忙")
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            textbutton _("過去的事件") action ShowMenu("過去的事件")

            textbutton _("儲存") action ShowMenu("儲存")

        if main_menu:

            imagebutton auto "gui/main_menu/buttons/load_%s.png" xpos 826 ypos 456 focus_mask True action ShowMenu("load")

        else:
            textbutton _("載入") action ShowMenu("載入")

        if main_menu:
            imagebutton auto "gui/main_menu/buttons/options_%s.png" xpos 818 ypos 516 focus_mask True action ShowMenu("preferences")
        ...
        imagebutton auto "gui/main_menu/buttons/about_%s.png" xpos 830 ypos 569 focus_mask True action ShowMenu("about")

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Help isn't necessary or relevant to mobile devices.
            imagebutton auto "gui/main_menu/buttons/help_%s.png" xpos 853 ypos 626 focus_mask True action ShowMenu("help")

        if renpy.variant("pc"):

            ## The quit button is banned on iOS and unnecessary on Android and
            ## Web.
            imagebutton auto "gui/main_menu/buttons/quit_%s.png" xpos 853 ypos 682 focus_mask True action Quit(confirm=not main_menu)

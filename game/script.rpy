    ...
    frame:
        ...
        vbox:
            ...
            vbox:
                spacing 10
                text "Name:"
                input id "name_input" default "" value VariableInputValue("player_name") changed SetFocus("age_input")
  
                text "Age:"
                input id "age_input" default "" value VariableInputValue("player_age") changed SetFocus("color_input")

                text "Favorite Color:"
                input id "color_input" default "" value VariableInputValue("player_color")
